...
//   pool
//     .query(
//       "insert into to_do_and_events (to_do_items, to_do_date, to_do_priority, event_name, event_address, event_time, event_date) values ($1::text, $2::date, $3::text, $4::text, $5::text, $6::time, $7::date)",
//       [
//         req.body.to_do_items,
//         req.body.to_do_date,
...
//   pool
//     .query(
//       "update to_do_and_events set to_do_items=$1::text, to_do_date=$2::date, to_do_priority=$3::text, event_name=$4::text, event_address=$5::text, event_time=$6::time, event_date=$7::date where id=$8::int",
//       [
//         req.body.to_do_items,
//         req.body.to_do_date,
//         req.body.to_do_priority,
